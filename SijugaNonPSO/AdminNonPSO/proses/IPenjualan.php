...
mysqli_query($koneksi, "INSERT INTO penjualan VALUES('','$tanggal','$no_registrasi','$nama_akun','$pembayaran','$qty_55kg','$harga_55kg','$jumlah_55kg','$qty_12kg','$harga_12kg','$jumlah_12kg','$jumlah','$keterangan','$file')");

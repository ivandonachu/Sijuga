...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM penjualan_pso a INNER JOIN customer b ON b.kode_customer=a.kode_customer WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Penjualan Tabung Kosong' ");
} else {

    $table = mysqli_query($koneksi, "SELECT * FROM penjualan_pso a INNER JOIN customer b ON b.kode_customer=a.kode_customer WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Penjualan Tabung Kosong' ");
}
...
<head>
    ...
    <title>Rincian Penjualan Tabung Kosong</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Posisi Halaman -->
                    <small class="m-0 font-weight-thin text-primary"><a href="DsSijugaNonPSO">Dashboard</a> <i style="color: grey;" class="fa fa-caret-right" aria-hidden="true"></i> <a style="color: grey;">Rincian Penjualan Tabung Kosong</a> </small>
                    <br>
                    <br>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h5 style="color: grey;">Rincian Penjualan Tabung Kosong</h5>
                        </div>
                        <!-- Card Body -->
                                    ...
                                    <table align="center" id="example" class="table-sm table-striped table-bordered  nowrap" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_array($table)) {
                                                ...
                                                <td style='font-size: clamp(12px, 1vw, 15px); color: black;' >"; ?> <?= formatuang($harga_3kg); ?> <?php echo "</td>
                                                ...
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                            Total Penjualan</div>
                                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= formatuang($total_penjualan) ?></div>
                                                    </div>
                                                    <div class="col-auto">

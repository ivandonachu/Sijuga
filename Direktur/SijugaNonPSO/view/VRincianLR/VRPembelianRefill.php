...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM pembelian WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Pembelian Refill'");
} else {

    $table = mysqli_query($koneksi, "SELECT * FROM pembelian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Pembelian Refill'");
}
